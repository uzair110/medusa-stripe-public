...
exports.default = (function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var validated, logger, productService, pricingService, productVariantService, shippingProfileService, featureFlagRouter, productVariantInventoryService, inventoryService, salesChannelService, entityManager, productModuleService, isWorkflowEnabled, createProductWorkflow, input, products, product;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                products = (_a.sent()).result;
                return [2 /*return*/, res.json({ product: products[0] })];
            case 3: return [4 /*yield*/, entityManager.transaction(function (manager) { return __awaiter(void 0, void 0, void 0, function () {
                    var variants, shippingProfile, defaultSalesChannel, newProduct, _a, _b, _c, index, variant, optionIds_1, allVariantTransactions, transactionDependencies_1, variantsInputData, varTransaction, e_1, rawProduct, _d, product;
                    var e_2, _e;
                    var _f, _g;
                        ...
                        switch (_h.label) {
                            ...
                            case 4:
                                if (!(featureFlagRouter.isFeatureEnabled(sales_channels_1.default.key) &&
                                    !((_f = validated === null || validated === void 0 ? void 0 : validated.sales_channels) === null || _f === void 0 ? void 0 : _f.length))) return [3 /*break*/, 6];
                                return [4 /*yield*/, salesChannelService
                                        .withTransaction(manager)
                                        .retrieveDefault()];
                            case 5:
                                defaultSalesChannel = _h.sent();
                            ...
                            case 7:
                                ...
                                optionIds_1 = ((_g = validated === null || validated === void 0 ? void 0 : validated.options) === null || _g === void 0 ? void 0 : _g.map(function (o) { var _a; return (_a = newProduct.options.find(function (newO) { return newO.title === o.title; })) === null || _a === void 0 ? void 0 : _a.id; })) || [];
                            ...
                            case 11:
                                _h.sent();
                                throw e_1;
                            case 12: return [4 /*yield*/, productService
                                    .withTransaction(manager)
                            ...
                            case 14:
                                _d = __read.apply(void 0, [_h.sent(), 1]), product = _d[0];
