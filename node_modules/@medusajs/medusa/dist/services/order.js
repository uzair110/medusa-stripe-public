...
var OrderService = /** @class */ (function (_super) {
    ...
    OrderService.prototype.decorateTotals = function (order, totalsFieldsOrContext) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var newTotalsServiceTx, calculationContext, returnable_items, returnableItems, isReturnableItem, allItems, orderShippingMethods, itemsTotals, shippingTotals, item_tax_total, shipping_tax_total, giftCardTotal, _o, _p, swap, _q, _r, claim;
            var e_16, _s, e_17, _t;
            return __generator(this, function (_u) {
                switch (_u.label) {
                    ...
                    case 1: return [2 /*return*/, _u.sent()];
                    case 2:
                    ...
                    case 6:
                        ...
                        return [4 /*yield*/, this.newTotalsService_.getGiftCardTotals(order.subtotal - order.discount_total, {
                                ...
                                giftCardTransactions: (_k = order.gift_card_transactions) !== null && _k !== void 0 ? _k : [],
                            })];
                    case 7:
                        giftCardTotal = _u.sent();
                        ...
                        try {
                            for (_o = __values((_l = order.swaps) !== null && _l !== void 0 ? _l : []), _p = _o.next(); !_p.done; _p = _o.next()) {
                                swap = _p.value;
                        ...
                        try {
                            for (_q = __values((_m = order.claims) !== null && _m !== void 0 ? _m : []), _r = _q.next(); !_r.done; _r = _q.next()) {
                                claim = _r.value;
